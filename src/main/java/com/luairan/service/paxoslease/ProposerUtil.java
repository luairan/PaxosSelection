...
public class ProposerUtil {
	...
	private  static  long  realProposeSeconds =Long.parseLong(Configration.getValueByName("/client/paxos-server", "realProposeSeconds"));
	private  static  int  oneFailRetrySeconds =Integer.parseInt(Configration.getValueByName("/client/paxos-server", "oneFailRetrySeconds"));
	private  static  long  waitSeconds =Long.parseLong(Configration.getValueByName("/client/paxos-server", "waitSeconds"));
	private  static  long  successReProposeSeconds =Long.parseLong(Configration.getValueByName("/client/paxos-server", "successReProposeSeconds"));
